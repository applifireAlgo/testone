 ...
 * 
 */
Ext.define("Shoppingportal.view.scheduleconfiguration.tree.ScheduleConfigTree", {
	extend : 'Ext.panel.Panel',
	requires : [ 'Shoppingportal.view.scheduleconfiguration.tree.ScheduleConfigTreeController' ],
