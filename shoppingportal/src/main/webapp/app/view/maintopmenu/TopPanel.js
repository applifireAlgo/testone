 ...
 */
Ext.define('Shoppingportal.view.maintopmenu.TopPanel', {
	extend : 'Ext.toolbar.Toolbar',
	xtype : 'topToolbar',
	
	requires : [ 'Shoppingportal.view.maintopmenu.TopPanelController',
	             'Shoppingportal.view.maintopmenu.MenuPanel' ],
