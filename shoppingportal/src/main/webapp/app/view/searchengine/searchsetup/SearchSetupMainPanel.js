 ...
 * 
 */
Ext.define('Shoppingportal.view.searchengine.searchsetup.SearchSetupMainPanel', 
{
	extend : 'Ext.panel.Panel',
	xtype : 'searchsetup',
	requires : [ 'Ext.layout.container.HBox', 'Ext.layout.container.VBox', 'Shoppingportal.view.searchengine.searchsetup.SearchSetupMainPanelController',
	             'Shoppingportal.view.searchengine.searchsetup.ChartFieldsModel',
	           ],
