Ext
		.define(
				'Shoppingportal.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Shoppingportal.view.searchengine.search.SearchEngineMainPanelController','Shoppingportal.view.searchengine.search.PanelHeaderField' ,'Shoppingportal.view.searchengine.search.ReportGridView','Shoppingportal.view.searchengine.search.ReportChartView','Shoppingportal.view.searchengine.search.documentView','Shoppingportal.view.searchengine.search.DouMeanView','Shoppingportal.view.googlemaps.map.MapPanel'],
