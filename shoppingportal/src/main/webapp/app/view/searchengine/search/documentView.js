Ext
		.define(
				'Shoppingportal.view.searchengine.search.documentView',
				{
					...
					requires : [
							...
							'Shoppingportal.view.searchengine.search.documentController',
							'Shoppingportal.view.searchengine.search.RowExpander' ],
