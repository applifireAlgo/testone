Ext.define('Shoppingportal.view.fw.mainViewPanel.MainPanelController', {
	extend : 'Ext.app.ViewController',
	requires : ['Ext.util.Cookies',
	            'Shoppingportal.view.login.ChangePasswordScreen'],
	...
	afterRender:function()
	{
		...
		if(cookieChangePwd=="true"){
			 var component = Ext.create("Shoppingportal.view.login.ChangePasswordScreen",
							{
								modal:true,
							});
			 component.show();
