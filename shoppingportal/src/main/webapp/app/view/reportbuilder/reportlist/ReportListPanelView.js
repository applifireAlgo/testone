Ext.define('Shoppingportal.view.reportbuilder.reportlist.ReportListPanelView', {
	extend : 'Ext.panel.Panel',
	requires:['Shoppingportal.view.reportbuilder.reportlist.ReportListPanelController'],
