Ext.define('Shoppingportal.view.reportbuilder.querycriteria.QueryCriteriaView', {
	extend : 'Ext.grid.Panel',
	requires:['Shoppingportal.view.reportbuilder.querycriteria.QueryCriteriaController',
	          'Shoppingportal.store.QueryCriteriaWidgetsStore',
	          'Ext.grid.RowEditor',
	          'Shoppingportal.view.reportbuilder.querycriteria.QueryCriteriaModel'
	          ],
	...
	columns : [
				...
				},
				{
					...
					editor : {
						...
						store : 'Shoppingportal.store.QueryCriteriaWidgetsStore',
						queryMode : 'local',
						forceSelection : true,
						triggerAction : 'all',
						selectOnFocus : true,
