Ext.define('Shoppingportal.view.reportbuilder.properties.RptDataEndPointGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Shoppingportal.view.reportbuilder.properties.RptDataEndPointGridController'],
