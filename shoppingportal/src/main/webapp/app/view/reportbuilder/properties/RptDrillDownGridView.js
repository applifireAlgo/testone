Ext.define('Shoppingportal.view.reportbuilder.properties.RptDrillDownGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Shoppingportal.view.reportbuilder.properties.RptDrillDownGridController'],
