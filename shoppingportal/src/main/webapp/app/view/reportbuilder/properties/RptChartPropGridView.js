Ext.define('Shoppingportal.view.reportbuilder.properties.RptChartPropGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Shoppingportal.view.reportbuilder.properties.RptChartPropGridController'],
