 ...
 * 
 */
Ext.define('Shoppingportal.view.logalarm.mainscreen.LogAlarmMainViewTabPanelController', {
	...
	{
		debugger;
		var component = Ext.create("Shoppingportal.view.logalarm.mainscreen.AddLogAlarm", {
			title : "Log Module",
		});
