 ...
 * 
 */
Ext.define('Shoppingportal.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Shoppingportal.view.logalarm.mainscreen.AddLogAlarmController',
			'Shoppingportal.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Shoppingportal.view.logalarm.mainscreen.AppAlarmPanel',
