Ext.define('Shoppingportal.view.art.masterform.MasterPanelController', {
	     ...
	     Ext.Ajax.request(
 	             {
 	                 ...
 	                 success : function(response,currentObject){
 	                	 ...
 	                	 debugger;
 	                	  var masterFormPanelViewModel = Ext.create('Shoppingportal.view.art.masterform.MasterFormViewModel');
 	                	  ...
 	                	  var newFormPanelViewModel = Ext.create('Shoppingportal.view.art.masterform.MasterFormViewModel');
