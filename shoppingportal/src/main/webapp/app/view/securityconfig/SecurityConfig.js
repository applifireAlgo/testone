 ...
 * 
 */
Ext.define('Shoppingportal.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Shoppingportal.view.securityconfig.SecurityConfigController',
			'Shoppingportal.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
