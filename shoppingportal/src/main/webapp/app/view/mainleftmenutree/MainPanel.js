Ext.define('Shoppingportal.view.mainleftmenutree.MainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'mainPanelWithLeftMenu',

	requires : [ 'Shoppingportal.view.resource.ResourcePanel',
			'Shoppingportal.view.mainleftmenutree.TopPanel.TopPanel',
			'Ext.layout.container.Accordion', 'Ext.Img', 'Ext.button.Split',
			'Shoppingportal.view.resource.DockedResourcePanel','Shoppingportal.view.fw.mainViewPanel.MainPanelController' ],
