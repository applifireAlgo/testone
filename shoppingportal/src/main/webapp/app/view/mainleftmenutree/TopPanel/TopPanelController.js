Ext.define('Shoppingportal.view.mainleftmenutree.TopPanel.TopPanelController', {
	...
	onSearchClick : function(button) {
		...
		//	"Shoppingportal.view.scheduler.scheduler"
		var component = Ext.create(
				"Shoppingportal.view.searchengine.search.SearchEngineMainPanel", {
					closable : true,
					title : "Search Engine",
					refId : "-1"
				});
	...
	{
		var component = Ext.create(
				"Shoppingportal.view.clouddrive.CloudDrive", {
					closable : true,
					title : "Cloud Drive",
					//refId : "-1"
				});
