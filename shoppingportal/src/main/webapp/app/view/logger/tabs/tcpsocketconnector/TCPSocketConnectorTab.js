...
Ext
		.define(
				'Shoppingportal.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
				{
					...
					requires : [ 'Shoppingportal.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTabController' ],
