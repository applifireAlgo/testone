 ...
 * 
 */
Ext.define('Shoppingportal.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Shoppingportal.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
