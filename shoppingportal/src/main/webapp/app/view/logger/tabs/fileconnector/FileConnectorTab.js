 ...
 * 
 */
Ext.define('Shoppingportal.view.logger.tabs.fileconnector.FileConnectorTab', {
	...
	requires : ['Shoppingportal.view.logger.tabs.fileconnector.FileConnectorTabController'],
