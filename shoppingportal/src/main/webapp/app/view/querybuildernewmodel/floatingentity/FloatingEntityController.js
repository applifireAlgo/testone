Ext.define('Shoppingportal.view.querybuildernewmodel.floatingentity.FloatingEntityController',
{
			extend : 'Ext.app.ViewController',
			alias : 'controller.floating-entity',
			requires:['Shoppingportal.view.querybuildernewmodel.floatingentity.EntityColumnGrid',
			          'Shoppingportal.view.querybuildernewmodel.queryentitiesjoins.Query',
			          'Shoppingportal.view.querybuildernewmodel.floatingentity.EntitySprite',
