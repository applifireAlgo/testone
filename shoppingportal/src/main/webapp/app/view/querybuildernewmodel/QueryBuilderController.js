Ext.define('Shoppingportal.view.querybuildernewmodel.QueryBuilderController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-builder',
	requires:['Shoppingportal.view.querybuildernewmodel.queryentitiesjoins.QueryFieldsStore',
	          'Shoppingportal.view.querybuildernewmodel.queryentitiesjoins.QueryEntitiesStore',
	          'Shoppingportal.view.querybuildernewmodel.queryentitiesjoins.EntityJoinStore',
	...
	openQueryDetailWindow : function(saveBtn){
		...
		var queryWindow = Ext.create('Shoppingportal.view.querybuildernewmodel.querydetail.QueryDetail');
