Ext.define('Shoppingportal.view.querybuildernewmodel.querycondition.QueryWhereCondition', {
	extend : 'Ext.tree.TreePanel',
	requires:['Shoppingportal.view.querybuildernewmodel.querycondition.QueryWhereConditionController'],
