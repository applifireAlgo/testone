Ext.define('Shoppingportal.view.querybuildernewmodel.querycondition.QueryWhereConditionController', {
	...
	beforeCellEdit : function(editor, context, eOpts){
		...
		if(context.record.isRoot()||(context.record.isFirst()&&context.colIdx ==1 && 
			...
			var whereClauseWindow = Ext.create('Shoppingportal.view.querybuildernewmodel.querycondition.QueryWhereClauseWindow',{
