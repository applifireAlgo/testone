Ext.define('Shoppingportal.view.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Shoppingportal.view.reportui.datachart.chart.RatingField','Shoppingportal.view.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
