Ext.define("Shoppingportal.view.clouddrive.documentview.DocumentListView",{
		extend : 'Ext.panel.Panel',
		requires : [ 'Shoppingportal.view.clouddrive.documentview.DocumentListViewController',
