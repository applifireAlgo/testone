Ext.define('Shoppingportal.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Shoppingportal.view.usermanagement.enduser.UserProfileController', 'Shoppingportal.view.usermanagement.admin.AddUserDetailsViewModel', 'Shoppingportal.model.AddUserDataModel' ],
