Ext.define('Shoppingportal.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Shoppingportal.view.usermanagement.admin.UserPasswordReset',
	            'Shoppingportal.view.usermanagement.admin.AddUserDetails',
	            'Shoppingportal.view.usermanagement.admin.ViewUser'],
