Ext.define('Shoppingportal.view.mobileview.main.TopPanel.TopMenu', { 
	extend: 'Ext.toolbar.Toolbar',
    xtype: 'topMenu',
    requires:['Shoppingportal.view.mobileview.main.TopPanel.TopMenuController',/*'Shoppingportal.view.mobileview.main.ResourceWindow'*/],
        ...
        items: [
                {		text: 'Resorces',
                		handler:function(panel,e,eOpts)
                    	{
                    		debugger;
                    		var westAccodianPanel = this.up().up().up().up().up().down('#appMenuTreePanel');
                    		var resourceWindow = Ext.create('Shoppingportal.view.mobileview.main.ResourceWindow');
