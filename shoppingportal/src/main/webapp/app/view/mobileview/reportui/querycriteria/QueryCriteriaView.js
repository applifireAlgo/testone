Ext
		.define(
				'Shoppingportal.view.mobileview.reportui.querycriteria.QueryCriteriaView',
				{
					extend : 'Ext.panel.Panel',
					requires : [ 'Shoppingportal.view.mobileview.reportui.querycriteria.QueryCriteriaController' ],
					xtype : 'querycriteria',
