Ext.define('Shoppingportal.view.mobileview.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Shoppingportal.view.mobileview.reportui.datachart.chart.RatingField','Shoppingportal.view.mobileview.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
