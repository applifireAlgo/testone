Ext.define('Shoppingportal.shoppingportal.web.com.shopping.controller.onlineshopping.ItemMainController', {
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var formPanel = this.getView().up().down("#Item");
     ...
     onDeleteActionColumnClickMainGrid: function(grid, rowIndex) {
          var recordId = grid.store.data.items[rowIndex].data.itemId;
          me = this;
     ...
     loadData: function(responseData) {
          this.view.down('#Item').getViewModel().setData(responseData.response.data);
     },
