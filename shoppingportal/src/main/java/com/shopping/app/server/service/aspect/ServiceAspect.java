package com.shopping.app.server.service.aspect;
...
public class ServiceAspect {
    ...
    @Pointcut("execution(* com.shopping.app.server.service..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.shopping.app.server.service..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.shopping.app.server.service..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.shopping.app.server.service..*..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void allOperation() {
    }

    @Pointcut("execution(* com.shopping.app.server.service..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.shopping.app.server.service..get*(..))")
