package com.shopping.app.server.repository.aspect;
...
public class RepositoryAspect {
    ...
    @Pointcut("execution(* com.shopping.app.server.repository..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.shopping.app.server.repository..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.shopping.app.server.repository..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.shopping.app.server.repository..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.shopping.app.server.repository..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.shopping.app.server.repository..*(..))")
