...
@SourceCodeAuthorClass(createdBy = "vikas.gandhi@nagarro.com", updatedBy = "", versionNumber = "1", comments = "Repository for Gender Master table Entity", complexity = Complexity.LOW)
public class GenderRepositoryImpl extends SearchInterfaceImpl implements GenderRepository<Gender> {
    ...
    public List<Gender> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.shopping.app.shared.contacts.Gender> query = emanager.createQuery("select u from Gender u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<Gender> save(List<Gender> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                com.shopping.app.shared.contacts.Gender obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.shopping.app.shared.contacts.Gender s = emanager.find(com.shopping.app.shared.contacts.Gender.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public Gender findById(String genderId) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.shopping.app.shared.contacts.Gender listOfGender = (com.shopping.app.shared.contacts.Gender) query.getSingleResult();
            return listOfGender;
        } catch (javax.persistence.PersistenceException e) {
