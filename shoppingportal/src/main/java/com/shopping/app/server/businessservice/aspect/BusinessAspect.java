package com.shopping.app.server.businessservice.aspect;
...
public class BusinessAspect {
    ...
    @Before("execution(* com.shopping.app.server.repository.*Impl.save(..))")
    public void beforeSaveAdvice(JoinPoint joinPoint) throws SpartanConstraintViolationException {
        Object obj[] = joinPoint.getArgs();
    }

    @After("execution(* com.shopping.app.server.businessservice..*(..))")
