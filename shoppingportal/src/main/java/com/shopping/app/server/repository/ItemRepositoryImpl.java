...
@SourceCodeAuthorClass(createdBy = "vikas.gandhi@nagarro.com", updatedBy = "", versionNumber = "1", comments = "Repository for Item Master table Entity", complexity = Complexity.LOW)
public class ItemRepositoryImpl extends SearchInterfaceImpl implements ItemRepository<Item> {
    ...
    public List<Item> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.shopping.app.shared.onlineshopping.Item> query = emanager.createQuery("select u from Item u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public Item save(Item entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<Item> save(List<Item> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.shopping.app.shared.onlineshopping.Item obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.shopping.app.shared.onlineshopping.Item s = emanager.find(com.shopping.app.shared.onlineshopping.Item.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(Item entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<Item> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.shopping.app.shared.onlineshopping.Item obj = entity.get(i);
    ...
    public Item findById(String itemId) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.shopping.app.shared.onlineshopping.Item listOfItem = (com.shopping.app.shared.onlineshopping.Item) query.getSingleResult();
            return listOfItem;
        } catch (javax.persistence.PersistenceException e) {
