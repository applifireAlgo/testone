...
import com.shopping.app.shared.contacts.ContactType;
...
@SourceCodeAuthorClass(createdBy = "vikas.gandhi@nagarro.com", updatedBy = "", versionNumber = "1", comments = "Repository for ContactType Master table Entity", complexity = Complexity.LOW)
public class ContactTypeRepositoryImpl extends SearchInterfaceImpl implements ContactTypeRepository<ContactType> {
    ...
    public List<ContactType> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.shopping.app.shared.contacts.ContactType> query = emanager.createQuery("select u from ContactType u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<ContactType> save(List<ContactType> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                com.shopping.app.shared.contacts.ContactType obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.shopping.app.shared.contacts.ContactType s = emanager.find(com.shopping.app.shared.contacts.ContactType.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public ContactType findById(String contactTypeId) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.shopping.app.shared.contacts.ContactType listOfContactType = (com.shopping.app.shared.contacts.ContactType) query.getSingleResult();
