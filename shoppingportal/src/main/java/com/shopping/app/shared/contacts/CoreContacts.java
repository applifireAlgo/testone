package com.shopping.app.shared.contacts;
...
public class CoreContacts implements Serializable, CommonEntityInterface, CoreContactsInterface, Comparator<CoreContacts> {
    ...
    public CoreContacts addAddress(Address _address) {
        if (this.address == null) {
            this.address = new java.util.ArrayList<com.shopping.app.shared.location.Address>();
        }
        if (_address != null) {
    ...
    public CoreContacts addCommunicationData(CommunicationData _communicationData) {
        if (this.communicationData == null) {
            this.communicationData = new java.util.ArrayList<com.shopping.app.shared.contacts.CommunicationData>();
        }
    ...
    public boolean equals(Object obj) {
        try {
            com.shopping.app.shared.contacts.CoreContacts other = (com.shopping.app.shared.contacts.CoreContacts) obj;
            if (contactId == null) {
                return false;
