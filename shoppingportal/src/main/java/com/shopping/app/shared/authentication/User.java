package com.shopping.app.shared.authentication;
...
public class User implements Serializable, CommonEntityInterface, UserInterface, Comparator<User> {
    ...
    public User addPassRecovery(PassRecovery _passRecovery) {
        if (this.passRecovery == null) {
            this.passRecovery = new java.util.ArrayList<com.shopping.app.shared.authentication.PassRecovery>();
        }
    ...
    public boolean equals(Object obj) {
        try {
            com.shopping.app.shared.authentication.User other = (com.shopping.app.shared.authentication.User) obj;
            if (userId == null) {
                return false;
