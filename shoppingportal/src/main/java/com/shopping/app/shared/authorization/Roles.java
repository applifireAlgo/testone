package com.shopping.app.shared.authorization;
...
public class Roles implements Serializable, CommonEntityInterface, Comparator<Roles> {
    ...
    public Roles addRoleMenuBridge(RoleMenuBridge _roleMenuBridge) {
        if (this.roleMenuBridge == null) {
            this.roleMenuBridge = new java.util.ArrayList<com.shopping.app.shared.authorization.RoleMenuBridge>();
        }
    ...
    public boolean equals(Object obj) {
        try {
            com.shopping.app.shared.authorization.Roles other = (com.shopping.app.shared.authorization.Roles) obj;
            if (roleId == null) {
                return false;
