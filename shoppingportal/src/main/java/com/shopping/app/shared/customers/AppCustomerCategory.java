package com.shopping.app.shared.customers;
...
public class AppCustomerCategory implements Serializable, CommonEntityInterface, Comparator<AppCustomerCategory> {
    ...
    public boolean equals(Object obj) {
        try {
            com.shopping.app.shared.customers.AppCustomerCategory other = (com.shopping.app.shared.customers.AppCustomerCategory) obj;
            if (appcustCategoryId == null) {
                return false;
