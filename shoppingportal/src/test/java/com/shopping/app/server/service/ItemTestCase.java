...
public class ItemTestCase {
    ...
    public void test1Save() {
        try {
            Item item = new Item();
            item.setItemIcon("vAT");
            item.setItemName("dEuOnGYNvrdfpkWska2WiM5nCCDVagSKS51KkBxbisyhdlPZZ6");
    ...
    public void test2Update() {
        try {
            ...
            item.setItemIcon("ZoO");
            item.setItemName("1suf4XhAMWx16YLYqaSVSzCJcXNlhM6QTprJoX8yGbyEUW76kT");
            item.setItemPrice(12.34);
            item.setItemStock(2147483647);
            item.setVersionId(1);
