...
import com.shopping.app.server.repository.CurrencyRepository;
import com.shopping.app.shared.location.Currency;
...
public class CurrencyTestCase {
    ...
    public void test1Save() {
        try {
            ...
            country.setCapital("8gYJKfvajlbleHGUsMOfc2KxzdeKwMuT");
            country.setCapitalLatitude(2);
            country.setCapitalLongitude(11);
            country.setCountryCode1("9oY");
            country.setCountryCode2("8yN");
            country.setCountryFlag("lkPJAUWE53XN0RMq0bxUbhlbPhO7LfXwTRurFCeEHlgj5do4hd");
            country.setCountryName("2dJohEwnuBkWBoLRz5Td0T7rPDxTESY0ZMQuFHwaGnEi2ZVJas");
            country.setCurrencyCode("ass");
            country.setCurrencyName("CDFxHFKgZCIkGHD1inXhg6DkGZ9T5HP3PM4nYFqcKNVU3pdFCm");
            country.setCurrencySymbol("qf0QTIseYKjQOcMyx3vHhCYiYGaPqhV3");
            country.setIsoNumeric(11);
            Country CountryTest = countryRepository.save(country);
            map.put("CountryPrimaryKey", country._getPrimarykey());
            Currency currency = new Currency();
            currency.setCountryId((java.lang.String) CountryTest._getPrimarykey());
            currency.setCurrencyCode("W0uhqE2k2NrocPtmPM8qrrgI9g44Q2Z7bhf1kQcE7EVj5EE2dd");
            currency.setUnicodeDecimal("w3kN3jsHXLIyv3BxlHrQte4WOMat0xOg8RgsASCnUhaJT5x4rd");
            currency.setUnicodeHex("0iMvX4zDOnZeVVeVAh0zClmPI7LBAaU4xw7JP66rwNbJQJnDgC");
    ...
    public void test2Update() {
        try {
            ...
            currency.setCurrencyCode("26UkcCmmYtGJYEGV6NuQfCDBruDdWU4BC8qcsMywq46RuXbziY");
            currency.setUnicodeDecimal("wCRndnKHojtinQoLujbC1kRDTgRAQ0GGMGehRLgMKPNyHxPuju");
            currency.setUnicodeHex("iaLawFeRFi2bxJeKcXLkm8JsZQR2DTESlVeEB1q3JWrYiNbbFq");
