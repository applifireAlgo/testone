...
echo $PATH
OSNAME=`uname -s`
ART_DATA_PATH=/tmp/applifire/db/2CO6M2VLJDSV4VZJVRDFJQ/8423AFA0-0C9A-4916-B940-E958638F7BBE/art/data
AST_DATA_PATH=/tmp/applifire/db/2CO6M2VLJDSV4VZJVRDFJQ/8423AFA0-0C9A-4916-B940-E958638F7BBE/ast/data
DB_NAME=applifire
USER=root
PASSWORD=Glass4#21
PORT=3306
HOST=demo.applifire.com
MYSQL=/usr/bin
PROJECT_ID=2CO6M2VLJDSV4VZJVRDFJQ
